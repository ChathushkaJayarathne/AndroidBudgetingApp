...
public class IncomeHistoryActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Incomes Logs");
        ...
        todayIncomeItemsAdapter = new TodayIncomeItemsAdapter(IncomeHistoryActivity.this, myDataList);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    if (totalAmount >0){
                        ...
                        historyTotalAmountSpent.setText("Received $: "+ totalAmount);
                    }

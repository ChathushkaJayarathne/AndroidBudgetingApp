...
import com.CJMobAppDevpPrjct.PocketBudget.Adapters.TodayIncomeItemsAdapter;
...
public class TodayIncomeActivity extends AppCompatActivity {
    ...
    private TodayIncomeItemsAdapter todayIncomeItemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Today's Incomes");
        ...
        todayIncomeItemsAdapter = new TodayIncomeItemsAdapter(TodayIncomeActivity.this, myDataList);
        recyclerView.setAdapter(todayIncomeItemsAdapter);
    ...
    private void readPosts() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                todayIncomeItemsAdapter.notifyDataSetChanged();
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("Total day's income: $ "+ totalAmount);
                }
            }
    ...
    private void addItemSpentOn(){
        ...
        item.setText("What is the income source?");
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (budgetItem.equalsIgnoreCase("select item")){
                    Toast.makeText(TodayIncomeActivity.this, "Please select a valid item", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    incomeRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(TodayIncomeActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(TodayIncomeActivity.this, "Failed to add Item", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });

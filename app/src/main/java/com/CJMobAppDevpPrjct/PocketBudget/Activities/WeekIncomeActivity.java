...
import com.CJMobAppDevpPrjct.PocketBudget.Adapters.WeekIncomeItemsAdapter;
...
public class WeekIncomeActivity extends AppCompatActivity {
    ...
    private WeekIncomeItemsAdapter weekIncomeItemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weekIncomeItemsAdapter = new WeekIncomeItemsAdapter(WeekIncomeActivity.this, myDataList);
        recyclerView.setAdapter(weekIncomeItemsAdapter);

        if (getIntent().getExtras()!= null){
            type =getIntent().getStringExtra("type");
            if (type.equals("week")){
                getSupportActionBar().setTitle("This Week's Incomes");
                readWeekPosts();
            }else if (type.equals("month")){
                getSupportActionBar().setTitle("This Month's Incomes");
                readMonthPosts();
            }
        }
    }
    ...
    private void readMonthPosts() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                weekIncomeItemsAdapter.notifyDataSetChanged();
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This Month's Income: $ "+ totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount+=pTotal;
                    totalBudgetAmountTextView.setText("This week's Income: $ "+ totalAmount);
                }
            }

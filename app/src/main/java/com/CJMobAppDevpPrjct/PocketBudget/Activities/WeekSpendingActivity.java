...
import com.CJMobAppDevpPrjct.PocketBudget.Adapters.WeekItemsAdapter;
...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras()!= null){
            ...
            if (type.equals("week")){
                getSupportActionBar().setTitle("This Week's Expenses");
                readWeekPosts();
            }else if (type.equals("month")){
                getSupportActionBar().setTitle("This Month's Expenses");
                readMonthPosts();
            }
        }
    }
